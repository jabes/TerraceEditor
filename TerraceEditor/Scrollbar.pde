public class Scrollbar {
  ...
  void iterate () {
    if (
      ...
      if (mouse.isActive) {
        ...
        if (scrubX < posX + scrubPadding) {
          scrubX = posX + scrubPadding;
        } else if (scrubX > sizeWidth - scrubWidth - scrubPadding) {
          scrubX = sizeWidth - scrubWidth - scrubPadding;
        }
  ...
  // compare two values that will determine if the scrollbar is needed
